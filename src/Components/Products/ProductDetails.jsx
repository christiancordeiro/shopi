...
import ModalSwiperZoom from "./ModalSwiperZoom"
        ...
        <div key={produto.id} className="flex flex-col slidein">
          ...
          <div className="mt-4 text-center">
            ...
            <div className="mt-5 mb-6">
              <h2 className="text-zinc-200 mb-4 font-semibold">
                {produto?.title}
              </h2>
        ...
        >
          <div className="flex xl:grid-cols-2 gap-4">
            <div className="flex flex-col gap-4">
              <img
                className="w-80 h-64 object-cover rounded-md cursor-pointer"
                src={produto?.images[1]}
                alt="Product image 1"
                onClick={() => handleOpenModal(produto?.images[1])}
              />
              <img
                className="w-80 h-64 object-cover rounded-md cursor-pointer"
                src={produto?.images[2]}
                alt="Product image 2"
                onClick={() => handleOpenModal(produto?.images[2])}
              />
            </div>
            <div>
              <img
                className="w-[22.625rem] h-[33rem] object-cover rounded-md cursor-pointer"
                src={produto?.images[0]}
                alt="Product image 3"
                onClick={() => handleOpenModal(produto?.images[0])}
              />
            </div>
          </div>
          <div>
            ...
            <div className="mt-5 mb-6 text">
              ...
              <h3 className="text-zinc-400 w-[30rem]">
                {produto?.description}
              </h3>
            </div>
            <h1 className="text-2xl text-zinc-50 font-semibold mb-7">
